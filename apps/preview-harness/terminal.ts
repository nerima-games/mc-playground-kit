 ...
 *
 * Everything else here — the scenario script, the views, the probes, the option
 ...
 * harness itself keeps every parent behind an injected Port.
 *
 ...
 * fact about the fixture, reproducible on any machine, and not a fact about
 ...
 *
 * mc-worldgen's preview learned this the expensive way, and it is worth
 * carrying rather than rediscovering.
 */
